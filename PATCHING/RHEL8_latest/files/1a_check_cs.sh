...
echo "################################################" >> $update_log 2>&1
echo "INFO : Starting 1a_check_cs.sh at $(timestamp)" >> $update_log 2>&1
echo "INFO : Starting 1a_check_cs.sh at $(timestamp)"
...
echo "" >> $update_log 2>&1
echo "INFO : Finished 1a_check_cs.sh at $(timestamp)" >> $update_log 2>&1
echo "INFO : Finished 1a_check_cs.sh at $(timestamp)"
echo "################################################" >> $update_log 2>&1
